...
export const metadata: Metadata = {
    ...
    keywords: "автосервис казань, ремонт авто казань, 3d развал схождение, ремонт ходовой, замена масла, автозапчасти, константиновка, диагностика подвески, советский район, заречная 5б, авто14",
    openGraph: {
